...
export default function ReviewsPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <main className="flex-1 max-w-[1200px] mx-auto px-4 md:px-8 py-12">
        <Link href="/" className="inline-flex items-center gap-2 text-sm text-black/60 mb-6">
          <ChevronLeft className="w-4 h-4" /> Back to product
        </Link>

        <h1 className="text-3xl font-bold mb-4">All Reviews</h1>
        <p className="text-black/60 mb-6">Customer reviews for One Life Graphic T-shirt</p>

        <div className="space-y-5">
          {visible.map((review, idx) => (
            <div key={idx} className="border border-gray-200 rounded-3xl p-6">
